...
import SSLTableComparison from '../../../components/pricingPageComponents/SSLTableComparison';
                ...
                <section className="py-5">
                    <div className="mx-auto space-y-4">
                        <div className="flex flex-col justify-center items-center px-8 lg:px-0">
                            <h1 className="md:text-4xl text-3xl font-semibold font-syne text-gray-900 text-center">CRM / Hosting / Web Pages / Email Packages / SSL</h1>
                        ...
                        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-10 md:gap-12 py-10 md:py-5 lg:px-8 place-items-center">
                            ...
                            <EmailMarketingPricePlan price={emailPricing[plan]?.SEMPlans} plan={SEMPlans} />
                            <EmailMarketingPricePlan price={emailPricing[plan]?.SMMPlans} plan={SMMPlans} />
                            <EmailMarketingPricePlan price={emailPricing[plan]?.SEOPlans} plan={SEOPlans} />
                            <EmailMarketingPricePlan price={emailPricing[plan]?.advancedSEOPlans} plan={advancedSEOPlans} />
                            <EmailMarketingPricePlan price={emailPricing[plan]?.basicSEOPlans} plan={basicSEOPlans} />
                            <EmailMarketingPricePlan price={emailPricing[plan]?.emailMarketingPlans} plan={emailMarketingPlans} />
