    ...
    return (
        <div className='flex flex-col lg:flex-row justify-center items-center gap-4'>
            <div className='w-full lg:w-[50%] h-full p-3 space-y-10 lg:border-r lg:border-black'>
                <h1 className="text-center text-4xl align-middle font-semibold">Driving digital <br></br> revenue for our <br></br> 1000+ satisfied <br></br> customers</h1>
                <div className="px-[5%] lg:px-[15%]">
                    <div className='w-full flex flex-row justify-between items-center space-x-6 bg-white rounded-full pr-5 outline-none'>
                        <span className=" rounded-full text-3xl p-4 outline-none bg-gray-100"><MdRocket /></span>
                        ...
                        companyFeedback.map((feedBack) => (
                            ...
                            <div key={feedBack.id} className="carousel-item h-full space-y-10 mb-10">
                                <div className='p-3 flex flex-col space-y-6 justify-center items-start '>
                                    <div>
                                        <p className="text-2xl text-justify italic">{feedBack.opinion}</p>
                                    </div>
                                    <div className="space-y-1">
                                        <p className="text-sm font-medium text-black">{feedBack.companyCEO}</p>
                                        <p className="text-base uppercase">{feedBack.company}</p>
                                    </div>
                                </div>
                            </div>
