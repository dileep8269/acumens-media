const AboutSocialMediaSevices = ({ services }) => {
    return (
        <div className="flex flex-row flex-wrap gap-2 3xl:gap-32 2xl:gap-20 xl:gap-16 px-6 justify-center items-start">

            {
                services?.map((service, index) => (

                    <div key={index} className='flex flex-col 2xl:w-[380px] w-[300px] h-auto justify-items-start p-5 space-y-4 rounded-2xl'>
