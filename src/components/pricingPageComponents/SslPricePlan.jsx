...
const SslPricePlan = ({ price, plan }) => {
  const formatPrice = (price) => `$${price.toFixed(2)}`;

  return (
    <div className="relative bg-black w-[340px] lg:w-[420px] h-[880px] lg:h-[750px] rounded-[40px] shrink-0">
        ...
        <div className="absolute inset-y-[-6px] left-2.5 w-[340px] lg:w-[420px] h-[880px] lg:h-[750px] bg-white rounded-[40px] border border-black py-8 px-4 shrink-0">
