                    ...
                    <div className="flex justify-between items-center my-[20%]">
                        <div className="">
                            <div className="flex justify-center items-center mb-4 text-black">
                                <h6 className="font-kanit uppercase text-[12px] md:text-base tracking-tight leading-6 mr-4">REVIEWED ON</h6>
                            ...
                            <div className="flex justify-start items-center text-black">
                                <img className="object-contain mr-4 md:mr-14" src="F7.webp" alt="F7.webp" />
