...
export const TypeAnimation = () => {
    ...
    return (
        <div className='App'>
            <h1 className="text-4xl lg:text-5xl font-bold mb-4 font-syne">
                 <span className="text-4xl lg:text-5xl font-bold mb-4 font-syne"></span>“Unleash” the power of AI for 
                <br />
                <span className="text-4xl lg:text-5xl font-bold mb-4 font-syne">
