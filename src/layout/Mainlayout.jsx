  ...
  return (
    <>
      ...
      <div className="bg-blue-Purple">
        ...
        <div className="w-full pb-[30px] sm:pb-0 rounded-t-[40px] bg-gray-200">
      ...
      <div className="fixed left-0 bottom-0 w-full text-white text-center flex justify-center items-center gap-x-1 sm:hidden z-50 px-2">
